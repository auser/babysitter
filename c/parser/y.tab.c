...
{
      17,     0,    -1,    -1,    18,    19,    -1,    18,    13,    -1,
       3,    15,    -1,    19,     6,    -1,    19,    13,    -1,     6,
      -1
};
...
{
  "$end", "error", "$undefined", "KEYWORD", "BEFORE", "AFTER", "STRING",
  "DIRECTORIES", "EXECUTABLES", "ENV", "STDOUT", "STDIN", "ROOT_DIR",
  "ENDL", "BLOCK_SET", "':'", "$accept", "phase", "phase_decl", "line", 0
};
#endif
